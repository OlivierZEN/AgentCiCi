...
class MemorySemanticRetrievalServiceTest {
    @Test void returnsOnlyRecordsAlreadyAuthorizedByTheRelationalContext() throws Exception {
        ...
        MemorySemanticRetrievalService service=new MemorySemanticRetrievalService(embeddings, vectors, mock(MemoryVectorFragmentRepository.class), records, contexts);
