...
public class MemoryCandidateEntity {
    ...
    public MemoryCandidateEntity(String companyId, String agentId, Long subjectId, String scope, String scopeKey, String memoryType, String content, String sensitivity, BigDecimal confidence, Instant validFrom, Instant validTo, String sourceType, String sourceRefsJson) {
        this.companyId=companyId; this.agentId=agentId; this.subjectId=subjectId; this.scope=scope; this.scopeKey=scopeKey; this.memoryType=memoryType; this.content=content; this.sensitivity=sensitivity; this.confidence=confidence; this.validFrom=validFrom; this.validTo=validTo; this.sourceType=sourceType; this.sourceRefsJson=sourceRefsJson; this.status="PENDING"; this.createdAt=Instant.now(); this.updatedAt=createdAt;
    }
    ...
    public Long getId(){return id;} public String getCompanyId(){return companyId;} public String getAgentId(){return agentId;} public Long getSubjectId(){return subjectId;} public String getScope(){return scope;} public String getScopeKey(){return scopeKey;} public String getMemoryType(){return memoryType;} public String getContent(){return content;} public String getSensitivity(){return sensitivity;} public BigDecimal getConfidence(){return confidence;} public Instant getValidFrom(){return validFrom;} public Instant getValidTo(){return validTo;} public String getSourceType(){return sourceType;} public String getSourceRefsJson(){return sourceRefsJson;} public String getStatus(){return status;} public Instant getUpdatedAt(){return updatedAt;}
}
