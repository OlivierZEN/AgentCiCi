...
public class MemoryCandidateEntity {
    ...
    public MemoryCandidateEntity(String orgId, String agentId, Long subjectId, String scope, String scopeKey, String memoryType, String content, String sensitivity, BigDecimal confidence, Instant validFrom, Instant validTo, String sourceType, String sourceRefsJson) {
        this.orgId=orgId; this.agentId=agentId; this.subjectId=subjectId; this.scope=scope; this.scopeKey=scopeKey; this.memoryType=memoryType; this.content=content; this.sensitivity=sensitivity; this.confidence=confidence; this.validFrom=validFrom; this.validTo=validTo; this.sourceType=sourceType; this.sourceRefsJson=sourceRefsJson; this.status="PENDING"; this.createdAt=Instant.now(); this.updatedAt=createdAt;
    }
