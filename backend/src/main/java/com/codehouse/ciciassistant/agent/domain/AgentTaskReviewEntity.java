...
public class AgentTaskReviewEntity {
    ...
    public AgentTaskReviewEntity(String companyId, long runId, int reviewRound, String gateStatus,
                                 String reviewerStatus, String issueCodesJson, String resultSummary, Instant createdAt) {
        this.companyId = companyId; this.runId = runId; this.reviewRound = reviewRound; this.gateStatus = gateStatus;
