...
- task_status_path: `.claw/tasks/TASK-160.md`
- assignment_path: `.claw/assignments/TASK-160.yaml`
- blocked_by: `none`
- next_action: Done; comprehensive backend tenant-isolation test and related regression suite passed, with `ResponseStatusException` status preservation fixed.
