...
phase: maintenance
active_task: "TASK-156 readiness gate implemented; TASK-157 PDF parser, ACL, drift audit, and citation trust foundations implemented."
next_action: "Rerun focused integration tests when Docker/PostgreSQL is available; continue TASK-157 retrieval evaluation, connector sync, and embedding metadata drift; then TASK-156 minimal evaluation gate."
read_next:
  goals: false
  decisions: false
  issue_list: false
...
- TASK-157 first implementations added PDFBox text-based PDF parsing, document/chunk ACL, RAG/Chat permission filtering, drift audit/repair, and RAG citation trust fields; retrieval evaluation, connector sync, and embedding metadata drift remain.
