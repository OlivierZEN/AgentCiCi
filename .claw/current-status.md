...
kind: current-status
version: 3
updated_at: 2026-05-09T12:40:00Z
updated_by: ai
status: active
phase: release_v1_7_packaging
active_task: "TASK-069 Account tenant lifecycle and data retention implementation"
current_task: 正在打包并提交 V1.7 版本，备注为“全局账号结构，autoservice官网注册”；本次版本覆盖 FEAT-024 全局账号/租户生命周期主体和 FEAT-026 AutoService 官网注册预约闭环。
next_action: V1.7 推送完成后，FEAT-024 后续优先做外部对象存储适配器巡检、生产 Qdrant/外部向量库巡检 smoke、订阅状态自动驱动、Owner 侧关闭申请、真实邀请接受和席位类型；FEAT-026 后续补 UTM/CRM 归因、通知分派和公开站点部署配置。
read_next:
  goals: false
  decisions: true
  issue_list: true
