...
phase: production-invitation-lifecycle-backfill-complete
active_task: TASK-252
next_action: "监控已回填账户的初始化邮件投递和首次 OIDC 登录；正常公司管理员邀请的新成员应在完成 Keycloak 邮箱验证和设置密码后才激活。"
read_next:
  goals: false
  decisions: false
  issue_list: true
