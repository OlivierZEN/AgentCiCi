...
kind: team-status
version: 3
updated_at: 2026-05-21T09:21:52Z
...
- identity_status: `active`
- assigned_tasks: `TASK-114, TASK-117, TASK-118, TASK-124, TASK-125`
- active_tasks: `TASK-114, TASK-124`
- latest_pr: `none`
- contribution_status: `claimed, in_progress, merged`
- validation_status: `unknown`
...
| `TASK-124` | FEAT-046 platform tenant manual provisioning and lifecycle split | `MANAGER-001` | `in_progress` | `in_progress` | `unknown` | `not_ready` | `codex/TASK-124-feat-046-platform-tenant-provisioning` | `n/a` |
