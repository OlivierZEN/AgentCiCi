...
- 修复提交 `123619a7223e` 已进入本地 `main`；并行语音提交随后推进代码主线至 `7ced552aa661`，后者包含本修复。共享开发环境 backend 运行 `2.8.68-dev.7ced552`，frontend 运行仅多出治理文档的 `2.8.68-dev.118ff72`，两者 healthy/restart=0。
