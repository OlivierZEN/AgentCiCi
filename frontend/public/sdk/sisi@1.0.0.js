(function (global) {
  ...
  if (!sdkUrl) throw new Error("思思 SDK 必须通过 script src 加载");
  ...
  function instance(options) {
    ...
    if (mode === "page") {
      ...
      launcher.setAttribute("aria-label", "打开思思 AI Agent");
      launcher.innerHTML = '<span aria-hidden="true">思</span><span>问思思</span>';
      ...
      launcher.firstChild.style.cssText = "width:32px;height:32px;display:grid;place-items:center;border-radius:9px;color:#fff8eb;background:#b74632;font:20px 'Kaiti SC',serif;";
