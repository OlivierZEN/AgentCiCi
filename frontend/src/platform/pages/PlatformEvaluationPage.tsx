...
type Run = { id: number; companyId: string; agentId: string; suiteId: number; versionNo: number; status: string; passRate: number; p0FailedCount: number; safetyFailedCount: number; startedAt: string };
