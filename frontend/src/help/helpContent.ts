    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "`OWNER` 或 `ORG_ADMIN` 登录员工工作台后，可从“切换组织”菜单进入本组织管理后台，维护知识库、模型、技能、工具、智能体和用户。",
          "平台运营账号进入 `/platform/*`，处理跨租户的治理、审计和平台级配置。",
        ],
      },
      {
        title: "操作步骤",
        steps: ["打开员工工作台或平台运营入口。", "输入手机号或邮箱以及密码。", "组织管理员登录员工工作台后，在“切换组织”中选择目标组织的“管理后台”。", "如果没有目标入口权限，联系组织管理员或平台运营人员调整角色。"],
      },
      {
        title: "权限与安全说明",
