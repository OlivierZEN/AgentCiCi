...
export const helpCategories: HelpCategory[] = [
  ...
  { id: "admin", title: "管理后台", summary: "知识库、模型、技能、智能体和运行观测。" },
  { id: "platform", title: "平台控制面", summary: "平台治理、审计和租户生命周期。" },
...
export const helpDocs: HelpDoc[] = [
  ...
  {
    slug: "admin/models/providers",
    title: "模型配置",
    category: "admin",
    role: ["组织管理员"],
    entry: "/admin/models",
    summary: "配置阿里云百炼、Ollama、LM Studio 或 OpenAI-compatible 模型供应商和模型路由。",
    updatedAt: "2026-05-19",
    aliases: ["模型供应商", "百炼", "Ollama", "LM Studio", "模型路由"],
    prerequisites: ["你拥有组织管理员权限。", "你已经准备好供应商地址、模型名和必要密钥。"],
    sections: [
      {
        title: "操作步骤",
        steps: ["进入 `/admin/models`。", "选择或新增模型供应商。", "填写 base URL、模型名和 API Key。", "保存后拉取或测试模型列表。", "在模型路由区域为对话、会议纪要或其他场景选择默认模型。"],
      },
      {
        title: "权限与安全说明",
        bullets: ["密钥保存后通常不会明文回显。", "本地模型供应商可能不需要 API Key，但仍需要确保内网地址可访问。", "模型路由影响组织内智能体运行，应由管理员统一维护。"],
      },
      {
        title: "结果验证",
        bullets: ["供应商显示为可用。", "模型列表可以读取。", "一次测试对话能看到对应模型身份。"],
      },
      {
        title: "常见错误",
        bullets: ["base URL 末尾路径不符合供应商要求。", "把本地模型的不可访问地址填成浏览器本机地址。", "模型路由未保存，导致运行时仍使用旧模型。"],
      },
    ],
...
export const roleEntrypoints = [
  ...
  {
    role: "组织管理员",
    summary: "配置模型、知识库、技能、智能体、渠道和运行观测。",
    slugs: ["admin/models/providers", "admin/skills/create", "admin/agent-builder/overview", "admin/wechat-kf/setup"],
  },
  {
    role: "开发者",
