...
- `POST /openapi/v1/chat-messages` 支持 `response_mode=blocking|streaming`，并返回/发送 `task_id`、`message_id`、`conversation_id`、`answer`、usage、retriever resources、agent thoughts。
