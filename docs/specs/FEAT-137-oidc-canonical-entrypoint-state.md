...
- 已发布生产 `2.8.13 / 877337078ea8`。主站入口返回 `302 https://x.agentcici.com/auth/oidc/login?...`；规范入口才写入 state Cookie 并跳转 Keycloak。后端/前端健康、版本、Nginx 与公网入口 smoke 均通过；真实用户 Keycloak 登录留待用户复验。
